...
func (b *BtcWallet) SendOutputs(outputs []*wire.TxOut,
	...
	// Convert our fee rate from bro/kw to bro/kb since it's required by
	// SendOutputs.
...
// returned. This method also takes the target fee expressed in bro/kw that
...
func (b *BtcWallet) CreateSimpleTx(outputs []*wire.TxOut,
	...
	// The fee rate is passed in using units of bro/kw, so we'll convert
	// this to bro/KB as the CreateSimpleTx method requires this unit.
	feeSatPerKB := btcutil.Amount(feeRate.FeePerKVByte())
