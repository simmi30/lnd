...
func TestMissionControlStateSetLastPairResult(t *testing.T) {
	...
	// Report an 1100 bro failure one hour later. It is expected to
	...
	// Report a 1200 bro failure one second later. Because this increase of
