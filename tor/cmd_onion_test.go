...
func TestPrepareAddOnion(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			targetIPAddress: "",
			cfg:             AddOnionConfig{VirtualPort: 9732},
			expectedCmd:     "ADD_ONION NEW:RSA1024 Port=9732,9732 ",
			expectedErr:     nil,
		},
		{
		...
		},
		{
			...
			expectedCmd: "ADD_ONION NEW:RSA1024 " +
				"Port=9732,127.0.0.1:18000 " +
				"Port=9732,127.0.0.1:18001 ",
			expectedErr: nil,
		},
		{
