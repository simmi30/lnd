...
func TestWeightEstimator(t *testing.T) {
	...
	// Define a parent transaction that pays a fee of 30000 bro/kw.
	...
	// Define a parent transaction that pays a fee of 10000 bro/kw.
	...
	// bro/kw after subtraction of the fee that was already paid by the
	// parent.
