...
func TestTxInputSet(t *testing.T) {
	...
	// Create a 300 bro input. The fee to sweep this input to a P2WKH output
	...
	// A 700 bro input should be accepted into the set, because it yields
	// positively.
	...
	// Add a 1000 bro input. This increases the tx fee to 712 sats. The tx
...
func TestTxInputSetFromWallet(t *testing.T) {
	...
	// Add a 500 bro input to the set. It yields positively, but doesn't
...
func TestTxInputSetRequiredOutput(t *testing.T) {
	...
	// Create a 1000 bro input that also has a required TxOut of 1000 bro.
