...
const (
	...
	//
	// Given a minimum relay fee rate of 1 bro/vbyte, a multiplier of 10
	// would result in the following fee rate buckets up to the maximum fee
	// rate:
	//
	//   #1: min = 1 bro/vbyte, max = 10 bro/vbyte
	//   #2: min = 11 bro/vbyte, max = 20 bro/vbyte...
...
type UtxoSweeperConfig struct {
	...
	// UtxoSweeper.
	//
	// Given a minimum relay fee rate of 1 bro/vbyte, a fee rate bucket size
	// of 10 would result in the following fee rate buckets up to the
	// maximum fee rate:
	//
	//   #1: min = 1 bro/vbyte, max (exclusive) = 11 bro/vbyte
	//   #2: min = 11 bro/vbyte, max (exclusive) = 21 bro/vbyte...
