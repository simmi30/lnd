...
func sendPaymentRequest(ctx *cli.Context,
	...
	switch {
	// If the max shard size is specified, then it should either be in bro
	// or mbro, but not both.
...
// formatMsat formats mbro amounts as fractional sats.
...
func formatPayment(ctxc context.Context, payment *lnrpc.Payment,
	...
	fmt.Fprintf(b, "Amount + fee:   %v + %v bro\n",
