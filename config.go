...
const (
	...
	defaultRPCPort            = 10004
	defaultRESTPort           = 8080
	defaultPeerPort           = 9732
...
type Config struct {
	...
	RawExternalIPs    []string `long:"externalip" description:"Add an ip:port to the list of local addresses we claim to listen on to peers. If a port is not specified, the default (9732) will be used regardless of other parameters"`
	...
	MaxCommitFeeRateAnchors uint64 `long:"max-commit-fee-rate-anchors" description:"The maximum fee rate in bro/vbyte that will be used for commitments of channels of the anchors type. Must be large enough to ensure transaction propagation"`
...
func ValidateConfig(cfg Config, interceptor signal.Interceptor, fileParser,
	...
	// satoshis (10 BRON). Always enforce --maxchansize explicitly set by user.
