...
const (
	...
	// and cannot be changed during the life of the channel. It is 1 mbro by
	...
	// DefaultBitcoinStaticFeePerKW is the fee rate of 50 bro/vbyte
	// expressed in bro/kw.
	...
	// DefaultLitecoinStaticFeePerKW is the fee rate of 200 bro/vbyte
	// expressed in bro/kw.
