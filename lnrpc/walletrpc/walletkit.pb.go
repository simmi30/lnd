...
type PendingSweep struct {
	...
	//The fee rate we'll use to sweep the output, expressed in bro/vbyte. The fee
	...
	// The requested fee rate, expressed in bro/vbyte, for this output.
	//
	// Deprecated: Do not use.
...
type BumpFeeRequest struct {
	...
	//
	//Deprecated, use sat_per_vbyte.
	//The fee rate, expressed in bro/vbyte, that should be used to spend the input
	//with.
	//
	// Deprecated: Do not use.
...
type FundPsbtRequest_SatPerVbyte struct {
	//
	//The fee rate, expressed in bro/vbyte, that should be used to spend the
	//input with.
