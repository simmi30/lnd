...
var (
	// ErrSatMsatMutualExclusive is returned when both a bro and an mbro
	// amount are set.
	ErrSatMsatMutualExclusive = errors.New(
		"bro and mbro arguments are mutually exclusive",
	)
)
...
// UnmarshallAmt returns a strong mbro type for a bro/mbro pair of rpc fields.
