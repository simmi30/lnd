...
func testCommitmentTransactionDeadline(net *lntest.NetworkHarness,
	...
	const (
		// feeRateConfDefault(bro/kw) is used when no conf target is
	...
	// feeRateSmall(bro/kw) is used when we want to skip the CPFP
	...
	// 2500 bro/kw in this test.
	feeRateSmall := maxPerKw / 2

	// feeRateLarge(bro/kw) is used when we want to use the anchor
