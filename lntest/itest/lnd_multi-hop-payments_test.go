...
func testMultiHopPayments(net *lntest.NetworkHarness, t *harnessTest) {
	...
	// The final node bob expects to get paid five times 1000 bro.
	...
	// To forward a payment of 1000 bro, Alice is charging a fee of
	// 1 bro + 10% = 101 bro.
	...
	// To forward a payment of 1101 bro, Dave is charging a fee of
	// 5 bro + 15% = 170.15 bro. This is rounded down in rpcserver to 170.
