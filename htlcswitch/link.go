...
func (l *channelLink) sampleNetworkFee() (chainfee.SatPerKWeight, error) {
	// We'll first query for the bro/kw recommended to be confirmed within 3
	// blocks.
	...
	l.log.Debugf("sampled fee rate for 3 block conf: %v bro/kw",
		int64(feePerKw))
...
func (l *channelLink) updateChannelFee(feePerKw chainfee.SatPerKWeight) error {
	...
	l.log.Infof("updating commit fee to %v bro/kw", feePerKw)
