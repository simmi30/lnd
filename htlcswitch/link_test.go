...
func TestChannelLinkCancelFullCommitment(t *testing.T) {
	...
	// Fill up the commitment from Alice's side with 20 bro payments.
...
func TestLinkForwardFeePolicyMismatch(t *testing.T) {
	...
	// current default fee of 1 BRO, if we just send a single BRON over in
...
func TestLinkForwardMinHTLCPolicyMismatch(t *testing.T) {
	...
	// for the three-hop-network is 5 BRO. So in order to trigger this
	// failure mode, we'll create an HTLC with 1 bronees.
...
func TestUpdateForwardingPolicy(t *testing.T) {
	...
	// First, send this 10 mBRO payment over the three hops, the payment
