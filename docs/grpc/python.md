...
channel = grpc.secure_channel('localhost:10004', creds)
...
is at the default `localhost:10004`, with an open channel between the two nodes.
...
channel = grpc.secure_channel('localhost:10004', combined_creds)
stub = lnrpc.LightningStub(channel)
