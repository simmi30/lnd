...
type WtClient struct {
	...
	// SweepFeeRate specifies the fee rate in bro/byte to be used when
	// constructing justice transactions sent to the tower.
	SweepFeeRate uint64 `long:"sweep-fee-rate" description:"Specifies the fee rate in bro/byte to be used when constructing justice transactions sent to the watchtower."`
}
