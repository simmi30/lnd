...
func TestEncodeAmount(t *testing.T) {
	...
	tests := []struct {
		...
		{
			mbro:   200000000000, // mSat
			valid:  true,
			result: "2", // BRON
		},
		{
			mbro:   200000000000000, // mSat
			valid:  true,
			result: "2000", // BRON
		},
		{
			mbro:   200900000000000, // mSat
			valid:  true,
			result: "2009", // BRON
		},
		{
			mbro:   123400000000000, // mSat
			valid:  true,
			result: "1234", // BRON
		},
		{
			mbro:   2100000000000000000, // mSat
			valid:  true,
	...
	for i, test := range tests {
		shortened, err := encodeAmount(test.mbro)
		if (err == nil) != test.valid {
